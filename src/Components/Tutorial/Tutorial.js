  ...
  return (
    <div>
      ...
      <div style={{ display: dialogue === 12 ? "inline" : "none" }}>
        ...
        <div>
          <p className="fade-in-text">Image of plant will go here.</p>
        </div>
        <button
          className="fade-in-text"
          aria-label="next"
      ...
      <div className="tutorial">
        ...
        <div style={{ display: dialogue === 16 ? "inline" : "none" }}>
          <p className="fade-in-text">
            When your plant is fully grown, someone in town might be interested
            in it, and you might be interested in what they will trade for it.
            You can visit the town to talk to the townspeople.
          </p>
