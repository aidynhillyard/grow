    ...
    <div>
      <Alert show={showF1} variant="success">
        <div className="npc-dialogue">
          <p>
            This is when you can trade the plant to Farhana. She is excited you
            have it. There will be some conditional logic going on here.
          </p>
          <Button
            onClick={() => {
              tradeDealFarhana();
        ...
        <div className="player-dialogue">
          <p>Your response to what she says.</p>
        </div>
